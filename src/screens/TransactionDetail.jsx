...
const ShareIcon = require("../../assets/share_white.png");
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.topNavContainer}>
                ...
                // onPress={() => navigation.goBack()}
                >
                    <Image source={ShareIcon} style={{ width: 12, height: 12, }} />
                </TouchableOpacity>
            </View>
            <View style={{ alignItems: 'center' }}>
                <Text style={{ fontSize: 26, color: 'white' }}>+60 USDT</Text>
                <Text style={{ fontSize: 14, color: 'gray' }}>~$60.02</Text>
            </View>

            <View style={{ flex: 1, width: '100%', flexDirection: 'column', justifyContent: 'flex-start', padding: 24 }}>
                <View style={{ flexDirection: 'column', gap: 24 }}>
                    <View>
                        <View>
                            <View style={styles.inforItem}>
                                <Text style={{ color: 'white', fontSize: 16 }}>Date</Text>
                                <Text style={{ color: 'gray' }}>Sep 19, 2:14 AM</Text>
                            </View>
                        ...
                        <View>
                            <View style={styles.inforItem}>
                                <Text style={{ color: 'white', fontSize: 16 }}>Sender</Text>
                    ...
                    <View>
                        ...
                        <View>
                            <View style={styles.inforItem} >
                                <Text style={{ color: 'white', fontSize: 16 }}>Nonce</Text>
                ...
                <TouchableOpacity
                    ...
                    style={{ width: '100%', marginTop: hp('6%') }}
                >
                    <LinearGradient
                    ...
                    >
                        <View style={styles.innerGradient}>
                            <Text style={{ color: 'white', fontSize: 16, textTransform: 'uppercase' }}>More Details</Text>
                        </View>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
